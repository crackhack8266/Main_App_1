...
const Constants = {
  ...
  NUTRITIONAL_VALUES_DROP_DOWN: [
    ...
    {id: 4, label: 'Item 4', value: 'item_4'},
    {id: 5, label: 'Item 5', value: 'item_5'},
    {id: 6, label: 'Item 6', value: 'item_6'},
    {id: 7, label: 'Item 7', value: 'item_7'},
    {id: 8, label: 'Item 8', value: 'item_8'},
    {id: 9, label: 'Item 9', value: 'item_9'},
    {id: 10, label: 'Item 10', value: 'item_10'},
    {id: 11, label: 'Item 11', value: 'item_11'},
    {id: 12, label: 'Item 12', value: 'item_12'},
  ],
  STATUS_DROP_DOWN: [
    {
      icon: () => (
